  ...
  return (
    <>
      <E.Wrapper>
        ...
        <E.Bottom>
          <ScrollView>
            ...
            <E.BottomDetailsWrapper>
              <E.DetailTitle>{children ? '편지를 남겨주세요!' : props.planTitle}</E.DetailTitle>
              ...
              {!children && (
                ...
                >
                  <E.DetailContent>
                    ...
                    각각 한국어와 영어로 번역하는 봉사에 참여하게 되요! 후원자 및 아동 편지 한-영
                    번역 오프라인 모임 참석 번역봉사를 시작하기 전, 번역봉사자가 한 자리에 모이는
                    오리엔테이션에 참석해 주시면 번역봉사 활동이 가능해요. 온라인 커뮤니티 활동
                    비전메이커 번역봉사단 홈페이지의 번역 커뮤니티를 통해, 다른 봉사자님들과 편지
                    번역 및 봉사 활동에 대해 자유롭게 이야기를 나눌 수 있어요!
                  </E.DetailContent>
                </ReadMore>
              )}
            </E.BottomDetailsWrapper>
        ...
        <GreenButton text={'나도 참여하기'} height={'52px'} onPressBtn={props.onPressSupport} />
      </E.Wrapper>
    </>
  );
};
