      ...
      <S.Wrapper>
        ...
        <S.Submit_Wrapper>
          <GreenButton
            ...
            fontSize="20px"
            height="50px"
            // onPressBtn={() => props.navigation.navigate({ screen: 'RegisterPage' })}
            // onPressBtn={() => props.navigation.push('RegisterPage')}
            // onPressBtn={() => props.navigation.navigate('community', { screen: 'list' })}
            // onPressBtn={() => props.navigation.navigate('Register', { screen: 'register' })}
            // onPressBtn={() => alert('testing')}
            onPressBtn={() => props.navigation.navigate('social')}
          />
        </S.Submit_Wrapper>
      </S.Wrapper>
    </>
